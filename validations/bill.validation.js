// validations/bill.validation.js — AR/AP Domain Refactor, Milestone M4 (API layer)
'use strict';
...
const shared = {
  ...
  vendorReferenceNumber:Joi.string().trim().max(100).allow(null, ''),
...
const updateBillSchema = Joi.object({ ...shared }).unknown(true);
